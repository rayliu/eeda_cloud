...
public class ExpCalculator {
    ...
    public static Stack<String> getParamsStack(String expression) {
        prepare(expression);
        return postfixStack;
    }
    ...
    public static void main(String[] args) {
        ...
        ExpCalculator cal  = new ExpCalculator();
        String s = "5+12*(3+5)/7";
        double result  = cal.calculate(s);
        System.out.println(result);
        
        System.out.println(ExpCalculator.getParamsStack("报关商品.数量*报关商品.单价-报关商品.单价1"));
